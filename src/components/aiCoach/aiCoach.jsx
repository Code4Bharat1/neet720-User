...
function ProgressBar({ value, className = "" }) {
  return (
    <div className={`w-full h-3 bg-gray-100 rounded-full overflow-hidden shadow-inner ${className}`}>
      <div
                  ...
                  {plan.tone_coach_notes && (
                    <div className="mt-4 pt-4 border-t border-blue-200">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <h4 className="font-semibold text-blue-800 mb-1">Coach Notes</h4>
                          <p className="text-sm text-blue-700">{plan.tone_coach_notes}</p>
                        </div>
                      </div>
                    </div>
                  )}
                            ...
                            {(() => {
                              ...
                              return (
                                <>
                                  {chapters.length > 0 && (
                                    <div>
                                      <h4 className="font-semibold text-gray-800 text-sm mb-2">Key Chapters:</h4>
                                  ...
                                  {description && (
                                    <div>
                                      <h4 className="font-semibold text-gray-800 text-sm mb-2">Focus Description:</h4>
              ...
              <section className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                <div className="p-6 sm:p-8">
                  ...
                  <div className="space-y-4">
                    {Object.entries(plan.plan).map(([phaseKey, info], idx) => (
                      <div 
                        key={phaseKey} 
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-3">
                              <h4 className="font-bold text-gray-900 text-lg capitalize">{phaseKey}</h4>
                            ...
                            <div className="space-y-2">
                              <h5 className="font-semibold text-gray-800 text-sm">Phase Overview:</h5>
                              <ul className="space-y-1">
                                {info?.description?.split('.').filter(item => item.trim()).map((point, idx) => (
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="space-y-4">
                  {weeks.map((w) => {
                    ...
                    const weekProgress = totalTasks ? (completedTasks / totalTasks) * 100 : 0;
                    
                    return (
                      <details key={w.weekKey} className="group bg-gradient-to-r from-gray-50 to-white rounded-xl border border-gray-200 overflow-hidden">
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <div className="space-y-1">
                                <h3 className="font-bold text-gray-900 text-lg capitalize">
                                  {w.weekKey.replace(/(week)(\d+)/i, "Week $2")}
                                </h3>
                                <div className="flex items-center gap-3">
                            ...
                            <ul className="space-y-3">
                              {w.items.map((t, idx) => {
                                ...
                                return (
                                  ...
                                  >
                                    <button
                                      onClick={() => toggleTask(w.weekKey, idx)}
                                    ...
                                    <div className="flex-1 min-w-0 space-y-2">
                                      <div className="flex flex-wrap items-center gap-2">
                                        <Pill className={meta.pill}>{t.subject}</Pill>
                                        <span className="font-bold text-gray-900 text-base">{t.chapter}</span>
                                      </div>
                                      <div className="space-y-1">
                                        <h5 className="font-semibold text-gray-800 text-sm">Task Details:</h5>
                                        <ul className="space-y-1">
                                          {t.task.split('.').filter(item => item.trim()).map((point, pointIdx) => (
                                            <li key={pointIdx} className="text-sm text-gray-700 leading-relaxed flex items-start gap-2">
                                              <span className="text-gray-400 mt-1">•</span>
                                              <span>{point.trim()}</span>
                                            </li>
                                          ))}
                  ...
                  {!weeks.length && (
                    <div className="text-center py-12 text-gray-600">
                      ...
                      <p className="text-lg font-medium">No weekly tasks found</p>
                      <p className="text-sm">Tasks will appear here once your AI plan is generated.</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex flex-col lg:flex-row gap-4 lg:items-center lg:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-600 max-w-2xl">
                    💡 <strong>Pro tip:</strong> Click each week to expand tasks and check off items as you complete them. 
