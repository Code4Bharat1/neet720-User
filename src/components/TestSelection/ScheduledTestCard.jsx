    ...
    return (
      <div className="p-3 sm:p-6">
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-gray-800">My Batches</h2>
        </div>
    ...
    <div className="p-3 sm:p-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <h2 className="text-xl sm:text-2xl font-semibold text-gray-800 mb-1">My Batches</h2>
            <p className="text-sm text-gray-600">
              {studentInfo.name && `Welcome, ${studentInfo.name}`}
            </p>
          </div>
          <div className="text-left sm:text-right">
            <div className="text-2xl sm:text-3xl font-bold text-blue-600">{batchData.length}</div>
