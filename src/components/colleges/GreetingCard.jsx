...
//       <div className="max-w-4xl mx-auto space-y-6">
//         {/* Header Card */}
//         <div className="relative bg-gradient-to-br bg-teal-400 text-white rounded-2xl shadow-xl p-8 overflow-hidden">
//           {/* Background Pattern */}
//           <div className="absolute inset-0 opacity-10">
//             <div className="absolute top-0 left-0 w-40 h-40 bg-white rounded-full -translate-x-20 -translate-y-20"></div>
//             <div className="absolute bottom-0 right-0 w-32 h-32 bg-white rounded-full translate-x-16 translate-y-16"></div>
...
//                   onClick={handlePredict}
//                   disabled={isLoading}
//                   className="flex-1 bg-teal-400 hover:bg-teal-700 disabled:bg-teal-400 text-white font-semibold py-4 px-6 rounded-lg transition-all transform hover:scale-[1.02] disabled:scale-100 flex items-center justify-center gap-2"
//                 >
//                   {isLoading ? (
//                     <>
//                       <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
...
const GreetingCard = () => {
  ...
  const uniqueCategories = useMemo(() => 
    ["General", "OBC", "SC", "ST", "EWS", "PWD"].sort(),
    []
  );

  const uniqueCourses = useMemo(() => 
    ["MBBS", "BDS", "BSc Nursing","BNYS","BUMS","BHMS","BAMS"].sort(),
    []
  );
  ...
  return (
    <div className="min-h-screen mt-10  p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        {/* Header Card */}
        <div className="relative bg-gradient-to-br from-teal-500 via-teal-600 to-cyan-600 text-white rounded-2xl shadow-xl p-8 overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-40 h-40 bg-white rounded-full -translate-x-20 -translate-y-20"></div>
            <div className="absolute bottom-0 right-0 w-32 h-32 bg-white rounded-full translate-x-16 translate-y-16"></div>
          ...
          {/* Bell Icon */}
          <div className="absolute top-6 right-6 bg-white/20 backdrop-blur-sm p-3 rounded-full hover:bg-white/30 transition-all cursor-pointer">
            <Bell className="text-white text-xl" />
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-2 lg:col-span-2">
              ...
              <input
                ...
                value={marks}
                onChange={handleMarksChange}
                className="w-full p-4 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all"
                max={720}
                min={0}
              />
            </div>
            ...
            <div className="space-y-2 self-end">
              ...
              <div className="flex gap-3">
                <button
                  onClick={handlePredict}
                  disabled={isLoading}
                  className="flex-1 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 disabled:from-teal-300 disabled:to-teal-400 text-white font-semibold py-4 px-6 rounded-lg transition-all transform hover:scale-[1.02] disabled:scale-100 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                >
                  {isLoading ? (
                    <>
                      <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>
                ...
                {(rankText || eligibleColleges.length > 0) && (
                  <button
                    onClick={resetPrediction}
                    className="px-6 py-4 border-2 border-teal-500 text-teal-700 rounded-lg hover:bg-teal-50 transition-all font-semibold"
                  >
                    Reset
                  </button>
                )}
        ...
        {rankText && (
          <div className="bg-white rounded-2xl shadow-xl p-6 space-y-6 border border-teal-100">
            {/* Predicted Rank */}
            <div className="bg-gradient-to-r from-teal-50 via-cyan-50 to-blue-50 border-2 border-teal-200 rounded-xl p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-2 flex items-center gap-2">
                <Award className="text-teal-600" />
                Your Predicted Rank
              </h3>
              <p className="text-2xl font-bold text-teal-700">{rankText}</p>
              <p className="text-sm text-gray-600 mt-1">
                Based on marks: {marks}/720 (Approximate AIR: ~{predictedRank})
              </p>
              <p className="text-xs text-gray-500 mt-2">
                *Results are filtered for <span className="font-semibold text-teal-600">{selectedCategory}</span> category and <span className="font-semibold text-teal-600">{selectedCourse}</span> course.
              </p>
            </div>
            ...
            {eligibleColleges.length > 0 ? (
              <div className="space-y-4">
                ...
                <div className="grid gap-4">
                  {eligibleColleges.map((college, index) => (
                    <div key={index} className="border-2 border-gray-200 rounded-lg p-5 hover:shadow-lg hover:border-teal-300 transition-all">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                        ...
                        <span className="text-teal-700 font-semibold bg-teal-50 px-3 py-1 rounded-full">
                          Cutoff AIR: {college.minAIR} - {college.maxAIR}
                        </span>
                      </div>
                    </div>
