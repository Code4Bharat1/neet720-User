      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Available Test Series</h1>
            <p className="text-gray-600">Choose from our collection of test series and start practicing</p>
          </div>
        </div>
        ...
        {testSeries.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Test Series Available</h3>
            <p className="text-gray-500 mb-6">Check back later for new test series</p>
          </div>
        ) : (
          <>
            {/* Stats Bar */}
              ...
              <div className="flex items-center justify-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Available Test Series</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="p-6 pb-4">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed mb-4 line-clamp-2">
                      {series.description || "Test your knowledge with this comprehensive series."}
                    </p>
                  </div>
                  ...
                  <div className="px-6 pb-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center gap-2 text-xs text-gray-500">
                        ...
                        Updated {new Date(series.createdAt).toLocaleDateString()}
                      </div>
                    </div>
                    
                    <button
                      className="w-full px-4 py-2.5 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 font-medium flex items-center justify-center gap-2 group-hover:shadow-md"
                      onClick={(e) => {
                        e.stopPropagation();
        ...
        {testSeries.length > 0 && (
          <div className="mt-12 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-8 text-center border border-green-100">
            ...
            <p className="text-gray-600 mb-4">Choose any test series above and start your learning journey today.</p>
