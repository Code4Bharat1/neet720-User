...
//     path: "/goalsetup", 
//     icon: <FaBullseye />,
//     activePaths: ["/goalsetup", "/examplan"] // Yeh logic add kiya hai
//   },
//   { name: "Test", path: "/testselection", icon: <FaClipboardList /> },
//   { name: "Result", path: "/pasttest", icon: <FaPoll /> },
//   { name: "Colleges", path: "/colleges", icon: <FaUniversity /> },
...
//             <nav className="space-y-2">
//               {sidebarLinks.map((item) => {
//                 // UPDATED LOGIC: Check activePaths array as well
//                 const isActive = pathname === item.path || (item.activePaths && item.activePaths.includes(pathname));
