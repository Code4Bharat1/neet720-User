...
const Login = () => {
  ...
  // The 'useEffect' that prevented access to the login page if a token existed
  // has been removed/kept commented out as per your request,
  // allowing users to attempt login every time.
