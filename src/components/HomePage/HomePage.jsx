...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      className="bg-gradient-to-br from-slate-50 via-teal-50/30 to-white py-16 md:py-24 overflow-hidden scroll-mt-16"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 space-y-6">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              Master NEET with focused resources, flexible revision plans, and
              personalized insights to ace 720 with clarity and confidence.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              {features.map((item, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="flex items-center gap-3 p-3 bg-white rounded-xl shadow-sm border border-gray-100 hover:shadow-md hover:border-teal-200 transition-all duration-300 cursor-pointer group"
                  >
            ...
            <div className="flex items-center gap-4 pt-2">
              <div className="flex -space-x-3">
                {["A", "B", "C", "D"].map((letter, i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-400 to-blue-500 border-2 border-white flex items-center justify-center text-white font-bold text-sm"
                  >
                    {letter}
                  </div>
                ))}
...
const Features = () => {
  ...
  return (
    <section
      id="features"
      className="py-20 bg-gradient-to-b from-white to-slate-50 scroll-mt-16"
    >
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Train your exam strategy, clear doubts expertly, and track every
            mark with intelligent insights.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, i) => {
            ...
            return (
              <div
                key={i}
                className="group bg-white p-8 rounded-3xl border border-gray-100 hover:border-teal-200 hover:shadow-2xl transition-all duration-500 relative overflow-hidden"
              >
...
const Practice = () => {
  const practiceItems = [
...

    {
      ...
      desc: "Simulate actual NEET with full-length mock tests.",
    },
    {
      icon: Zap,
      title: "Subject-wise Analysis",
      desc: "Drill down into Physics, Chemistry, and Biology.",
    },
    {
      icon: Target,
      title: "College Predictor",
      desc: "Estimate your chances at top medical colleges.",
    },
    {
      icon: Users,
      title: "Create Your Own Test",
      desc: "Build custom tests from PYQs or topics.",
    },
    {
      icon: Brain,
      title: "Fast Quiz Mode",
      desc: "Quick revision with time-bound quizzes.",
    },
    {
      icon: BookOpen,
      title: "Result & Ranks",
      desc: "Access previous tests with detailed solutions.",
    },
  ];
        ...
        <div className="grid md:grid-cols-3 lg:grid-cols-4 gap-4">
          {practiceItems.map((item, i) => {
            ...
            return (
              <div
                key={i}
                className="p-5 bg-gray-50 rounded-xl hover:bg-teal-50 transition cursor-pointer group"
              >
  ...
  const testimonials = [
    {
      name: "Aditi Sharma",
      score: "NEET 2024",
      review: "The analytics are detailed and have been a game changer for me.",
      rating: 5,
    },
    {
      name: "Rahul Verma",
      score: "Aspiring MBBS",
      review:
        "Love the AI chatbot feature! Every doubt gets resolved in seconds.",
      rating: 5,
    },
    {
      name: "Sneha Iyer",
      score: "Medical Aspirant",
      review:
        "Finally a platform that fits into my busy prep schedule perfectly.",
      rating: 5,
    },
  ];
...
const FAQ = () => {
  ...
  const faqs = [
    {
      q: "How is NEET 720 different from other platforms?",
      a: "We combine AI-powered analytics, adaptive learning, and comprehensive question banks for a personalized experience.",
    },
    {
    ...
    },
    {
      ...
      a: "Yes, we offer a 7-day free trial with full access to all Pro features.",
    },
    {
      q: "Do you support coaching institutes?",
      a: "Absolutely! Our Institute plan includes multi-student management and dedicated support.",
    },
  ];
          ...
          {faqs.map((faq, i) => (
            <div
              ...
              className={`bg-slate-50 rounded-2xl overflow-hidden transition-all duration-300 ${
                open === i
                  ? "shadow-lg ring-2 ring-teal-200"
                  : "hover:bg-slate-100"
              }`}
            >
              <button
              ...
              >
                ...
                >
                  <ChevronDown
                    className={`w-4 h-4 ${
                      open === i ? "text-white" : "text-gray-600"
                    }`}
                  />
                </div>
              </button>
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center md:text-left">
            ...
            {/* Call + WhatsApp Bar (IMAGE STYLE MATCH) */}
            <div className="flex items-center justify-center md:justify-start bg-[#f5f5dc] border border-gray-300 rounded-lg px-4 py-3 w-fit shadow-sm gap-4 mb-5">
              {/* WhatsApp */}
              <a
                href="https://wa.me/919152601933"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-400 hover:bg-green-100 transition"
              >
              ...
              {/* Phone */}
              <a
                href="tel:+919152601933"
                className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-400 hover:bg-gray-100 transition"
              >
