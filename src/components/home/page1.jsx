...
//   return (
//     <main className="relative flex flex-col items-center justify-start  overflow-hidden">
//       {/* Navbar */}
  

//       {/* Background Gradient */}
//       <section className="relative flex flex-col md:flex-row items-center justify-between w-full px-8 py-1 bg-gradient-to-br from-[#D8D5F5] via-[#A9A1F2] to-[#7F7ADF] overflow-hidden">
...
//           </p>
//           <button className="bg-[#00425A] text-white px-6 py-3 rounded hover:bg-[#00334a]">
//             Schedule A Demo Now
//           </button>
//         </div>

//         {/* Right Image with right side cut */}
//         <div className="md:w-1/2 mt-1 md:mt-[-80px] md:mr-[-30px] flex justify-end z-10">
...
// {/* Diagonal Left Polygon #1: FILLED SHAPE */}
// <div
//   className="absolute"
//   style={{
//     width: '166.43px',
...
//     top: '-74px',
//     left: '-120px',
//     backgroundColor: '#6460D9',
//     opacity: 0.7,
//     transform: 'rotate(-320.6deg)',
//     filter: 'blur(40px)',
//   }}
// ></div>

// {/* Diagonal Left Polygon #1: OUTLINE */}
// <div
//   className="absolute border border-[#00B2FF] bg-transparent"
//   style={{
//     width: '166.43px',
//     height: '768.34px',
//     top: '-74px',
...
// {/* Diagonal Left Polygon #2: FILLED SHAPE */}
// <div
//   className="absolute"
//   style={{
//     width: '194.33px',
...
// {/* Diagonal Left Polygon #2: OUTLINE */}
// <div
//   className="absolute border border-[#00B2FF] bg-transparent"
//   style={{
//     width: '194.33px',
...
//         className="fixed bottom-8 right-8 bg-green-500 rounded-full p-3 shadow-lg z-20"
//       >
//         <Image
//           src="/image 4.png"
//           alt="WhatsApp"
