...
import { FaPhoneAlt, FaEnvelope, FaWhatsapp, FaInstagram, FaFacebookF } from 'react-icons/fa';
    ...
    <footer className="bg-white text-black border-t">
      <div className="max-w-7xl mx-auto px-4 py-5 flex flex-col md:flex-row justify-between items-center md:items-start gap-4">
        ...
        <div className="flex flex-col items-center md:items-start">
          <Image src='/neet_logo.png' alt="NEET 720 Logo" width={200} height={100} />
        </div>
        ...
        <div className="flex flex-col items-center justify-center mt-6 text-center">
          ...
          <div className="flex space-x-4">
            <a href="#"><FaWhatsapp size={58} className="text-green-500 text-xl" /></a>
            <a href="#"><FaInstagram size={58} className="text-pink-500 text-xl" /></a>
            <a href="#"><FaFacebookF size={58} className="text-blue-600 text-xl" /></a>
          </div>
        </div>
      </div>
...
<div className="bg-teal-700 text-center text-black py-5 text-lg font-bold">
  ...
  <span className="relative group inline-flex items-center">
    ...
    <span className="absolute -top-8 left-1/2 -translate-x-1/2 flex items-center gap-1 whitespace-nowrap rounded bg-black px-2 py-1 text-xs text-white opacity-0 group-hover:opacity-100 transition">
      <PiLinkSimpleBold className="w-4 h-4" />Open code4bharat.com </span>
  </span>{' '}
  | All Rights Reserved.
</div>
