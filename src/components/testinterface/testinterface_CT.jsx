...
const TestInterface = () => {
  ...
  }, [timerInitialized.current]); // Re-run only when timer is initialized
                ...
                <div>
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-400 mt-1">Total Questions Across All Subjects: {totalQuestions} | Score: {totalQuestions * 4} marks</div>
                    </div>
                  </div>
            ...
            <div className="relative z-10 flex justify-between items-center pt-4 border-t border-gray-100">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Next
        ...
        <div className="lg:col-span-1 space-y-6">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3">
                  ...
                  <div className="text-2xl font-bold">{getAnsweredCount()}/{totalQuestions}</div>
                </div>
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-3">
                  <div className="flex items-center gap-2 mb-1">
                  ...
                  <div className="text-2xl font-bold">{getMarkedCount()}</div>
                </div>
              </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-gray-100 p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-gray-900">{currentSubject} Questions</h3>
            </div>
