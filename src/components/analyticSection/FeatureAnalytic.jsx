...
export default function FeatureAnalytic() {
  return (
    <section className="bg-gradient-to-br from-[#0f3b63] to-[#079ba1] rounded-[40px] py-16 px-4 sm:px-6 md:px-12 max-w-6xl mx-auto w-full">
      {/* Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-16 gap-x-10">
        {features.map((feature, index) => (
          ...
          >
            ...
            <p className="mt-2 text-sm md:text-base leading-relaxed">{feature.description}</p>
          </div>
        ))}
      </div>
    </section>
