export const metadata = {
  title:
    "viewanalyticsCT | NEET720 – India's Most Trusted NEET Preparation Platform",
  description:
    "Analyze your NEET chapter test performance with NEET720’s intelligent analytics dashboard.",
  openGraph: {
    url: "https://neet720.com/viewanalyticsCT",
    title: "viewanalyticsCT | NEET720",
    description:
      "Analyze your NEET chapter test performance with NEET720’s intelligent analytics dashboard.",
    siteName: "NEET720",
  },
...
import ViewAnalyticsHeader from "@/components/ViewAnalyticsCT/ViewAnalyticsHeader";
  ...
  return (
    <div className="md:flex min-h-screen relative">
      ...
      <div className="w-full md:w-5/6 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-0 mx-7 lg:px-3 lg:mx-0 my-14">
