                            ...
                            {difficulties.map((difficulty) => {
                                ...
                                return (
                                    <div 
                                        ...
                                        className={`group relative p-6 max-sm:p-1 rounded-2xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${colors.border} ${colors.bg} ${colors.hover}`}
                                    >
                                        {/* Selection Indicator */}
                                        {isSelected && (
                                            <div className={`absolute -top-2 -right-2 w-6 h-6 ${colors.text.replace('text-', 'bg-')} rounded-full flex items-center justify-center`}>
                                                <svg className="w-6 h-6 text-white bg-blue-400 rounded-full" fill="currentColor" viewBox="0 0 20 20">
                                        ...
                                        <div className='text-center'>
                                            <div className='mb-4 p-4 max-sm:p-1 bg-white rounded-xl shadow-sm'>
                                                <Image 
                                            ...
                                            {isSelected && (
                                                <div className='mt-4 p-4 max-sm:p-2 bg-white/70 rounded-lg border border-white/50'>
