...
const Page = () => {
    ...
    const difficulties = [
        ...
        { 
            ...
            Imagepath: "/hard-level-remove.png",
            color: 'red'
        }
    ];
                ...
                <div className='flex-1 overflow-y-auto px-6 py-8 md:py-12'>
                    <div className='max-w-5xl mx-auto'>
                        ...
                        <div className='text-center mb-8 md:mb-12'>
                            <div className='inline-flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm border border-slate-200 mb-4 md:mb-6'>
                                <BoltIcon className='h-6 w-6 md:h-7 md:w-7 text-indigo-600' /> 
                                <h1 className='text-xl md:text-2xl font-bold text-slate-800'>Fast Quiz</h1>
                            </div>
                        ...
                        <div className='mb-12 md:mb-16'>
                            <div className='text-center mb-6 md:mb-8'>
                                <h2 className='text-xl md:text-2xl font-bold text-slate-800 mb-2'>Select Your Challenge Level</h2>
                                <p className='text-slate-600 text-sm md:text-base'>Pick the difficulty that matches your current skill level</p>
                            </div>
                                ...
                                {difficulties.map((difficulty) => {
                                    ...
                                    return (
                                        <div 
                                            ...
                                            className={`group relative p-4 md:p-6 rounded-2xl border-2 cursor-pointer transition-all duration-300 transform hover:scale-105 hover:shadow-lg ${colors.border} ${colors.bg} ${colors.hover}`}
                                        >
                                            {/* Selection Indicator */}
                                            {isSelected && (
                                            ...
                                            <div className='text-center'>
                                                <div className='mb-3 md:mb-4 p-3 md:p-4 bg-white rounded-xl shadow-sm flex items-center justify-center h-32 md:h-36'>
                                                    <Image 
                                                ...
                                                {isSelected && (
                                                    <div className='mt-3 md:mt-4 p-3 md:p-4 bg-white/70 rounded-lg border border-white/50'>
                        ...
                        <div className='mb-12 md:mb-16'>
                            <div className='bg-white rounded-2xl p-6 md:p-8 shadow-sm border border-slate-200'>
                                <div className='text-center mb-6'>
                                    <h2 className='text-xl md:text-2xl font-bold text-slate-800 mb-2'>Customize Your Quiz</h2>
                                    <p className='text-slate-600 text-sm md:text-base'>How many questions would you like to tackle?</p>
                                </div>
                                ...
                                <div className='max-w-md mx-auto'>
                                    ...
                                    <div className='text-center'>
                                        <div className='inline-flex items-center gap-2 bg-indigo-50 px-4 py-2 rounded-full'>
                                            <span className='text-xl md:text-2xl font-bold text-indigo-600'>{numberOfQuestions}</span>
                                            <span className='text-indigo-600 font-medium text-sm md:text-base'>questions selected</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='flex justify-center'>
                            <button
                                ...
                                className={`group relative px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold text-base md:text-lg transition-all duration-300 transform ${selectedDifficulty
                        ...
                        {selectedDifficulty && (
                            <div className='mt-6 md:mt-8 text-center'>
                                <div className='inline-flex items-center gap-4 md:gap-6 bg-white px-4 md:px-6 py-2 md:py-3 rounded-full shadow-sm border border-slate-200'>
